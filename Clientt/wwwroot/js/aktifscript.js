$(document).ready(function () {
    let i = 0;
    var t = $("#tb_Aktifemployee").DataTable({
        "paging": true,
        "lengthChange": true,
        "searching": true,
        "ordering": true,
        ...
        "ajax": {
            url: "https://localhost:7235/api/Employees/active",
            type: "GET",
            "datatype": "json",
            "dataSrc": "data",
        ...
        "columns": [
            ...
            { "data": "department.name" },
            {
                "data": null, render: function (data, type, row) {
                    return '<button class="btn btn-warning" data-tooltip="tooltip" data-placement="bottom" title="Edit Aktif Employee" onclick="return GetById(\'' + row.nik + '\')"><i class="fas fa-edit"></i></button>'
                        + '&nbsp;' +
                        '<button class="btn btn-danger" data-tooltip="tooltip" data-placement="bottom" title="Delete Aktif Employee" onclick="return Delete(\'' + row.nik + '\')"><i class="fas fa-trash"></i></button>'
                }
            }], "order": [],
    });
